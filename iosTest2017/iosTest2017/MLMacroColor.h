...
NSArray *colors = @[HEX_COLOR(0x101329), HEX_COLOR(0x373A6F)]; \
bar.barTintColor = [UIColor colorWithGradientStyle:UIGradientStyleLeftToRight withFrame:CGRectMake(0, 0, ScreenWidth, NavigationBar_Height) andColors: colors]; \
