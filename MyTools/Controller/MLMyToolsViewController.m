...
@interface MLMyToolsViewController ()<UITableViewDelegate, UITableViewDataSource>
@property (strong, nonatomic) UITableView *tableView;

@property (strong, nonatomic) NSMutableArray<DiscoverAppItem *> *appItems;
@end

@implementation MLMyToolsViewController
...
- (void)initData {
    DiscoverAppItem *item = [[DiscoverAppItem alloc] initWithDisplayName:@"My Tools" version:@"5.2.0" size:@"25M" type:@"PLUGIN" description:@"Internet Bandwidth Speed Test is an internet speed meter. It can test speed for WIFI, 2G, 3G, 4G, DSL, and ADSL. With just one tap, it will test your Internet. "];
